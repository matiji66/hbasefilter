...
public class Hbase {
    ...
    static {
        ...
        conf.set(Constant.hbase_zookeeper_quorum,PropertyUtils.getValue(Constant.hbase_zookeeper_quorum));
...
//
//        // 查询某一列的值
//        getResultByColumn("obd_locus:locus_travel", "P006000400003488_2016-09-14 01:14:54", "f1", "start_poi");
//        // 更新列
...
//        // 删除表
//        deleteTable("blog2");
    	getResultScann("obd_locus:locus_travel");
